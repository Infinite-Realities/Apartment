...
namespace VRStandardAssets.Menu
{
    ...
    {
        public event Action<MenuSelection> OnButtonSelected;                   // This event is triggered when the selection of the button has finished.
        ...
        {
            ObjectControl.MenInx = MenuIndex;   
            m_GazeOver = false;
        }
